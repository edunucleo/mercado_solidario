...
jQuery(document).ready(function () {
    ...
    hantus_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_hantus_Social').val()>=5)
        {
        jQuery(".customizer_hdr_social_upgrade_section").show();
        return false;   
        }
         if(jQuery('#exist_hantus_Social').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_hantus_Social').val())+1;
         jQuery('#exist_hantus_Social').val(new_service_add_val);  
        }
        }
    ...
    hantus_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_hantus_Social').val(parseInt(jQuery('#exist_hantus_Social').val())-1); 
                }
            });
        }
        return false;
