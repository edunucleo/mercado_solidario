(function ($) {
    ...
    wp.hantuscustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                hantus_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.hantuscustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.hantuscustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.hantuscustomizerRepeater.iconPickerToggle($(this));
        });
