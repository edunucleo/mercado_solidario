...
$olivewp_only_thumbnail='';
if(( sizeof($olivewp_blog_post_order)==1)  && ($olivewp_blog_post_order[0] =='blog_image') && (! has_post_thumbnail())){ $olivewp_only_thumbnail=1;}
if(!empty($olivewp_blog_post_order) && $olivewp_only_thumbnail!=1):
					...
					<div class="entry-content">
						...
						{	
							if(get_theme_mod('olivewp_plus_enable_post_read_more',true)==true):?>
								<a href="<?php echo esc_url(get_the_permalink());?>" class="more-link" alt="<?php esc_attr_e('more-details','olivewp'); ?>"><?php esc_html_e('Read More','olivewp');?><i class="fas fa-chevron-right"></i></a>
							<?php 
							endif;
						} ?>
					</div>
