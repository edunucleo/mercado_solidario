...
Class MetForm_Input_Url extends Widget_Base{
    ...
    protected function render($instance = []){
		...
		<div class="mf-input-wrapper">
			...
			<input type="url" class="mf-input <?php echo esc_attr($class); ?>" id="mf-input-url-<?php echo esc_attr($this->get_id()); ?>" 
				name="<?php echo esc_attr($mf_input_name); ?>" 
				placeholder="<?php echo esc_html(\MetForm\Utils\Util::react_entity_support( $mf_input_placeholder, $render_on_editor )); ?>"
				<?php if ( !$is_edit_mode ): ?>
