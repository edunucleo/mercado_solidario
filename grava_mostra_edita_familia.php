...
?>
        <form method="post" action="app/controller/processa_cadastro.php">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['endereco']; ?>">
                <label for="nome">Endereço</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['auxilio']; ?>">
                <label for="nome">Sua família participa de algum Programa Social de auxílio do governo? Qual?</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['data_nasc']; ?>">
                <label for="nome">Data de Nascimento</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['telefone']; ?>">
                <label for="nome">Celular</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['renda']; ?>">
                <label for="nome">Qual é a renda financeira mensal da família?</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['moradores']; ?>">
                <label for="nome">Quantas pessoas moram com você? Coloque o nome e idade: (inclusive crianças e bebês)</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['termos']; ?>">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control focus border-warning" id="floatingInput" placeholder="text" value="<?php echo $cadastro['data_aprovacao']; ?>">
